        ...
        <template v-slot:[`item.actions`]="{ item }">
          ...
          <v-menu
              ...
              >
                ...
                <v-list>
                  <v-list-item>
                    <v-list-item-title class="pointer" @click.prevent="$router.push({name : 'recents-view' , params : {id : item.Id} , query: item })">
...
let body : object= {
  status : "rejected",
	reason :this.rejectReason
      ...
      EtaInvoicesRecentReject(this.updateUUID , body).then((res: any) => {
        this.table.loading = false;
        this.updateUUID = ""
        this.rejectReason = ""
      this.dialog = false
    ...
    getData() {
      this.table.loading = true;
      EtaInvoicesRecentList(this.filters.state).then((res: any) => {
        this.table.data = res;
        this.table.loading = false;
      });
    },
