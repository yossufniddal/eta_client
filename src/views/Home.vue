  ...
  <v-container class="mt-12">
    <div class="container-tiny">
      <v-row justify="center">
        ...
        <v-col class="scale-hover pointer" cols="12" md="3" sm="6">
          <count :count="counts[2].totalAmount" :title="'اجمالي مشتريات'" icon="mdi-cash-multiple" :color="'red'" />
        </v-col>
        <v-col class="scale-hover pointer" cols="12" md="3" sm="6">
          <count :count="counts[2].totalTax" :title="'اجمالي ضريبة مشتريات'" icon="mdi-cash-multiple" :color="'red'" />
        </v-col>
      </v-row>
      <v-row justify="center">
        <v-col class="scale-hover pointer" cols="12">
